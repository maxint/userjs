...
; (function (callback, safe) {
	...
	if (typeof(jQuery) === "undefined" || jQuery.jquery !== '2.1.4') {
		...
		script.addEventListener('load', function() {
			...
			cb.textContent = "var jq = jQuery.noConflict(); setTimeout(function(){ (" + callback.toString() + ")($, jq, window); }, 500);";
	...
	getScript("https://cdn.rawgit.com/ajaxorg/ace-builds/v1.2.5/src-min-noconflict/ace.js", function(){
		getScript("https://cdn.rawgit.com/ajaxorg/ace-builds/v1.2.5/src-min-noconflict/worker-html.js", function(){
